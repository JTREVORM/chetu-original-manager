      ...
      <div className="w-full max-w-sm overflow-hidden rounded-xl bg-white shadow-2xl">
        <div className="relative bg-[#0B4394] px-5 pb-5 pt-6 text-center text-white">
          ...
          <p className="mx-auto mt-1 max-w-xs text-[13px] leading-relaxed text-blue-100">
            Add it to your home screen to open it like any other app — full screen, one tap, no browser
            bar in the way.
          </p>
        </div>
        ...
        <div className="p-5">
          ...
          {platform === 'ios' && (
            <ol className="space-y-2.5 text-[13px] text-slate-700">
              ...
              <Step n={3}>Tap <b>Add</b>. Chetu then opens from your home screen.</Step>
            </ol>
          )}
          ...
          {platform === 'android-manual' && (
            <ol className="space-y-2.5 text-[13px] text-slate-700">
              <Step n={1}>
                Tap <MoreVertical className="mx-0.5 inline h-4 w-4 align-text-bottom text-[#0B4394]" />
          ...
          {platform === 'desktop-manual' && (
            <ol className="space-y-2.5 text-[13px] text-slate-700">
              ...
              <Step n={2}>Or open the browser menu and choose <b>Install Chetu Microfinance</b>.</Step>
