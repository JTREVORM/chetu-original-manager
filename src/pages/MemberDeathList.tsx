    ...
    <>
      ...
      <DeclareDeathModal
        ...
        onSave={async (deathDate) => {
          ...
          addToast(
            "info",
            "Member Recorded Deceased",
            `${declareFor.client.full_name} was moved to the Death List.`,
          );
          setDeclareFor(null);
        }}
      />
  ...
  return (
    <MisModal open onClose={onClose} title="Member Death Application" width="max-w-xl">
      ...
      <div className="grid grid-cols-1 gap-x-6 gap-y-2 sm:grid-cols-2">
        ...
        <Field label="Outstanding Balance">
          <input
            ...
            className="form-field bg-slate-100 font-bold"
          />
        </Field>
      </div>
      ...
      <p className="mt-2 text-[11px] text-slate-500">
        The member will be marked inactive and moved to the Member Death List. Any outstanding
        balance stays on the loan for follow-up.
      </p>
