...
export const LoWiseGroupRealizable: React.FC = () => {
  ...
  const groupRows = useMemo<GroupRow[]>(() => {
    ...
    return [...map.values()].sort(
      (a, b) =>
        a.officer_name.localeCompare(b.officer_name) || a.group_name.localeCompare(b.group_name),
    );
  ...
  const columns: MisColumn<GroupRow>[] = [
    {
      ...
      label: "Branch",
      width: "11%",
      render: (g) => g.branch_name,
      text: (g) => g.branch_name,
    },
    {
      key: "officer",
      label: "Loan Officer",
      width: "13%",
      render: (g) => g.officer_name,
      text: (g) => g.officer_name,
    },
    {
      key: "group",
      label: "Group",
    ...
    },
    {
      ...
      label: "Meeting Day",
      width: "9%",
      render: (g) => g.meeting_day,
      text: (g) => g.meeting_day,
    },
    {
      key: "members",
      label: "Members",
