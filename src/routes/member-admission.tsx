...
export const Route = createFileRoute("/member-admission")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Admit a new member into a lending group and open their savings passbook." },
      { property: "og:title", content: "Member Admission | Chetu Microfinance" },
      { property: "og:description", content: "Admit a new member into a lending group and open their savings passbook." },
