...
export const Route = createFileRoute("/member-inactive")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Review inactive members and re-admit them into an active group." },
      { property: "og:title", content: "Member Inactive List | Chetu Microfinance" },
      { property: "og:description", content: "Review inactive members and re-admit them into an active group." },
