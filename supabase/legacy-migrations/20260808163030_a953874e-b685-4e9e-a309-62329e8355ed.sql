...
-- client groups: officers see only groups they created, in their branches
...
-- clients: officers see only members they registered
...
-- loan products: everyone reads, admins write
...
-- applications / loans / schedules / repayments follow client visibility
...
-- ledgers: administrators (and auditors read-only)
